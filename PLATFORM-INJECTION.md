# Platform Injection Rules (TRD #2) — food-restaurant-001

> Runtime architecture mandates applied to every generated project.
> Runtime: **static** pipeline.
...
- CLS guard: ok.
- Backend blueprint:
  not applicable (API-less static runtime — backend blueprint not mounted (by design)).
